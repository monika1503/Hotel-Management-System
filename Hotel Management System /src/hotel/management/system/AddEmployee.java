...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    JLabel lblname,lblemail,lblage,lblsalary,lblphone,lblgender,lbljob,lblaadhar;
     JButton submit;
      JComboBox cbjob;
    ...
    AddEmployee()
    {
      ...
      lbljob=new JLabel("JOB");
       ...
       String str[]={ "Front Desk Clerks", "Porters", "Housekeeping","Kitchenstaff","Room service","Chefs","Waiter/Waitress","Manager","Accountant"};
